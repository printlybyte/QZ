...
public class DialogConfig {
    ...
    public  DialogConfig( int positiveButton,  int negativeButton, String rationaleMsg, int requestCode) {
        this(positiveButton,negativeButton, rationaleMsg,  requestCode, null);
    }

    public  DialogConfig( int positiveButton,  int negativeButton,
                           String rationaleMsg, int requestCode,
                           String[] permissions) {
