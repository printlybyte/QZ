...
public abstract class BaseShenpiFragment extends BaseFragment implements View.OnClickListener {
    ...
    private RecyclerView memberlist, copylist,listimgs;
    ...
    public void initViews(ViewGroup rootView) {
        ...
        copylist = (RecyclerView) rootView.findViewById(R.id.copylist);
