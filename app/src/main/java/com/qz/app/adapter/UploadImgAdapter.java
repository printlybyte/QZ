...
public class UploadImgAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public UploadImgAdapter(Context context, Fragment fragment, ArrayList list) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        L.v("UploadimgAdapter","item.url",item.url);
        L.v("UploadimgAdapter","item.name",item.name);
        L.v("UploadimgAdapter","item.fromnet",item.fromNet);
        L.v("UploadimgAdapter","position",position);
