...
public class ShenpiMemberHeadAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ShenpiMemberHeadAdapter(Context context, List list) {
            ...
            if (editMode) {
                ...
                ((ReaderViewHolder) holder).icon.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        bundle.putInt(Constant.EMP_FROM, Constant.EMP_FROM_SELECT_SHENPI);
