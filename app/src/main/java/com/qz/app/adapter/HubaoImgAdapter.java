...
public class HubaoImgAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public HubaoImgAdapter(Context context, Fragment fragment, ArrayList list) {
